...
for zz=1:9 % Define which movie to analyze
    close all;
    clearvars -except zz
    if zz==1
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1007_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1007_D1';

    elseif zz==2
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1008_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1008_D1';

    elseif zz==3
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1009_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1009_D1';

    elseif zz==4
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1010_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1010_D1';

    elseif zz==5
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1011_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1011_D1';

    elseif zz==6
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1012_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1012_D1';

    elseif zz==7
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1013_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1013_D1';

    elseif zz==8
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1014_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1014_D1';

    elseif zz==9
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_1015_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '1015_D1';
    end
    ...
    %% Load the datafile
    load([P.mouseID '_wholebody_data_withinROI.mat'])
    ...
    %     title('Paired trials')
    ylabel('Movement index (%max movement)'); xlabel('Time (s)');
    % Save figure
