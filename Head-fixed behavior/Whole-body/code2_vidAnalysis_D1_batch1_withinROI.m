...
for zz=1:6 % Define which movie to analyze
    ...
    clearvars -except zz
    if zz==1
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_974_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '974_D1';

    elseif zz==2
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_975_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '975_D1';

    elseif zz==3
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_976_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '976_D1';

    elseif zz==4
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_977_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '977_D1';

    elseif zz==5
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_978_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '978_D1';

    elseif zz==6
        P.filepath = ['Y:\Data\CN-SC_eyemov\WholebodyMovements\' 'wholebody_973_D1.avi'];
        P.startFrame = 1;
        P.mouseID = '973_D1';
    end
