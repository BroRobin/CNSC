...
cond1 = G.pupmov_cumsum_opto_opto0;
cond2 = G.pupmov_cumsum_opto_US;
figure;hold on
plot(mean(cond1))
...
plot(mean(cond2),'r')
% plot(mean(cond2))
nPerms=2000; % how many permutations do you want
...
% Save figure
cd('')
figname = sprintf('D2_pupilmovements_USvsopto0_clustertest.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_pupilmovements_USvsopto0_clustertest.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_pupilmovements_USvsopto0_clustertest.jpg')
saveas(gcf,figname,'jpg')

%% US versus opto50

cond1 = G.pupmov_cumsum_opto_opto50;
cond2 = G.pupmov_cumsum_opto_US;
figure;hold on
plot(mean(cond1))
...
% Save figure
cd('')
figname = sprintf('D2_pupilmovements_USvsopto50_clustertest.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_pupilmovements_USvsopto50_clustertest.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_pupilmovements_USvsopto50_clustertest.jpg')
saveas(gcf,figname,'jpg')
