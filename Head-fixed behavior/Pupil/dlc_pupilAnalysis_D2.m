...
for zz=8
    ...
    % Save figure
    figname = sprintf('%s_pupilmovements_indTrials_US_optoALL.fig',P.mouseID)
    saveas(gcf,figname,'fig');
    figname = sprintf('%s_pupilmovements_indTrials_US_optoALL.pdf',P.mouseID)
    orient(gcf,'landscape')
    print('-dpdf','-vector','-loose','-fillpage',figname)
    figname = sprintf('%s_pupilmovements_indTrials_US_optoALL.jpg',P.mouseID)
    ...
    % Save figure
    figname = sprintf('%s_saccadeDirectionPolarplots.fig',P.mouseID)
    saveas(gcf,figname,'fig');
    figname = sprintf('%s_saccadeDirectionPolarplots.pdf',P.mouseID)
    print('-dpdf','-vector','-loose',figname)
    figname = sprintf('%s_saccadeDirectionPolarplots.jpg',P.mouseID)
    saveas(gcf,figname,'jpg')
    ...
    % Save figure
    figname = sprintf('%s_cumsum_baselineVsOpto.fig',P.mouseID)
    saveas(gcf,figname,'fig');
    figname = sprintf('%s_cumsum_baselineVsOpto.pdf',P.mouseID)
    print('-dpdf','-vector','-loose',figname)
    figname = sprintf('%s_cumsum_baselineVsOpto.jpg',P.mouseID)
    saveas(gcf,figname,'jpg')
    ...
    % Save figure
    figname = sprintf('%s_pupilmovements_cumsum.fig',P.mouseID);
    saveas(gcf,figname,'fig');
    figname = sprintf('%s_pupilmovements_cumsum.pdf',P.mouseID);
    print('-dpdf','-vector','-loose',figname)
    figname = sprintf('%s_pupilmovements_cumsum.jpg',P.mouseID)
    saveas(gcf,figname,'jpg')
    ...
    % Save figure
    figname = sprintf('%s_pupildiameters_indTrials_US_optoALL.fig',P.mouseID)
    saveas(gcf,figname,'fig');
    figname = sprintf('%s_pupildiameters_indTrials_US_optoALL.pdf',P.mouseID)
    orient(gcf,'landscape')
    print('-dpdf','-vector','-loose','-fillpage',figname)
    figname = sprintf('%s_pupildiameters_indTrials_US_optoALL.jpg',P.mouseID)
    saveas(gcf,figname,'jpg')
    ...
    %% Save the data
    P.savename = sprintf('%s_pupil_data.mat',P.mouseID);
...
for zz=1:9
    ...
    if zz==1
        cd('')
        P.mouseID = '976_D2';
        load(sprintf('%s_pupil_data.mat',P.mouseID))
    elseif zz==2
        cd('')
        P.mouseID = '973_D2';
        load(sprintf('%s_pupil_data.mat',P.mouseID))
...
% Save figure
cd('')
figname = sprintf('D2_pupilmovements_USvsopto0_ChR2groupAVG.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_pupilmovements_USvsopto0_ChR2groupAVG.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_pupilmovements_USvsopto0_ChR2groupAVG.jpg')
saveas(gcf,figname,'jpg')
...
% Save figure
cd('')
figname = sprintf('D2_pupilmovements_USvsopto50_ChR2groupAVG.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_pupilmovements_USvsopto50_ChR2groupAVG.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_pupilmovements_USvsopto50_ChR2groupAVG.jpg')
saveas(gcf,figname,'jpg')
...
% Save figure
cd('')
figname = sprintf('D2_cumsum_pupilmovs_USvsopto0_ChR2groupAVG.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_cumsum_pupilmovs_USvsopto0_ChR2groupAVG.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_cumsum_pupilmovs_USvsopto0_ChR2groupAVG.jpg')
saveas(gcf,figname,'jpg')
...
% Save figure
cd('')
figname = sprintf('D2_cumsum_pupilmovs_USvsopto50_ChR2groupAVG.fig')
saveas(gcf,figname,'fig');
figname = sprintf('D2_cumsum_pupilmovs_USvsopto50_ChR2groupAVG.pdf')
orient(gcf,'landscape')
print('-dpdf','-vector','-loose',figname)
figname = sprintf('D2_cumsum_pupilmovs_USvsopto50_ChR2groupAVG.jpg')
saveas(gcf,figname,'jpg')



%% Save the data
P.savename = sprintf('D2_pupil_data_ChR2groupanalysis.mat');
