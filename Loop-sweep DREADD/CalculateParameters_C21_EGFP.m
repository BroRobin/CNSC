...
analyse =3 %1=EGFP Sweep, 3=EGFP Loom,
...
if analyse==1
    avg_escape_speed = NaN;
elseif analyse==3
    avg_escape_speed = escape_speed;
end
...
if analyse==1
    figure(h(1))
    box on;
    figname = 'C21_EGFP_sweep_speedvstime_freeze.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_sweep_speedvstime_freeze.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);

    figure(h(20))
    box on;
    figname = 'C21_EGFP_sweep_speedvstime_all.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_sweep_speedvstime_all.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);

    figure(h(3))
    box on;
    figname = 'C21_EGFP_sweep_freeze_cumprob.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_sweep_freeze_cumprob.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
    ...
    try
        figure(h(2))
        box on;
        figname = 'C21_EGFP_sweep_speedvstime_escape.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_sweep_speedvstime_escape.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);

        figure(h(4))
        box on;
        figname = 'C21_EGFP_sweep_escape_cumprob.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_sweep_escape_cumprob.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);
    end
elseif analyse==3
    figure(h(1))
    box on;
    figname = 'C21_EGFP_loom_speedvstime_freeze.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_loom_speedvstime_freeze.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);

    figure(h(20))
    box on;
    figname = 'C21_EGFP_loom_speedvstime_all.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_loom_speedvstime_all.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
    ...
    figure(h(3))
    box on;
    figname = 'C21_EGFP_loom_freeze_cumprob.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_loom_freeze_cumprob.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
    ...
    try
        figure(h(2))
        box on;
        figname = 'C21_EGFP_loom_speedvstime_escape.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_loom_speedvstime_escape.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);

        figure(h(4))
        box on;
        figname = 'C21_EGFP_loom_escape_cumprob.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_loom_escape_cumprob.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);
    end
end
...
if analyse==1
    ...
    figname = 'C21_EGFP_sweep_speedvstime_Medianfreeze_WT_gauss.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_sweep_speedvstime_Medianfreeze_WT_gauss.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
    ...
    try
        ...
        figname = 'C21_EGFP_sweep_speedvstime_Medianescape_WT_gauss.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_sweep_speedvstime_Medianescape_WT_gauss.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);
    ...
    line([0.75 0.75],   [min(get(gca, 'Ylim')) max(get(gca, 'Ylim'))], 'Color', 'r','LineWidth',0.5);
    colorbar;
    figname = 'C21_EGFP_sweep_speedvstime_Alltrials_gauss.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_sweep_speedvstime_Alltrials_gauss.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
...
elseif analyse==3
    ...
    figname = 'C21_EGFP_loom_speedvstime_Medianfreeze_WT_gauss.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_loom_speedvstime_Medianfreeze_WT_gauss.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
    ...
    try
        ...
        figname = 'C21_EGFP_loom_speedvstime_Medianescape_WT_gauss.fig';
        saveas(gcf,figname,'fig');
        figname = 'C21_EGFP_loom_speedvstime_Medianescape_WT_gauss.pdf';
        orient(gcf,'portrait')
        print('-dpdf','-painters','-loose',figname);
    ...
    line([0.75 0.75],   [min(get(gca, 'Ylim')) max(get(gca, 'Ylim'))], 'Color', 'r','LineWidth',0.5);
    colorbar;
    figname = 'C21_EGFP_loom_speedvstime_Alltrials_gauss.fig';
    saveas(gcf,figname,'fig');
    figname = 'C21_EGFP_loom_speedvstime_Alltrials_gauss.pdf';
    orient(gcf,'portrait')
    print('-dpdf','-painters','-loose',figname);
