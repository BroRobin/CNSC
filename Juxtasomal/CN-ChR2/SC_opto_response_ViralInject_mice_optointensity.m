...
clear all;
OutputVars=[];
for counter = 1:45 % Indicate which cell to analyse for example: (for counter = 1:3) or (for counter = 3)
    close all;
    ...
    elseif counter ==2
        %% 210309_2
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319003';
        P.cellID = '260319_1_Lv4';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
    ...
    elseif counter ==3
        %% 210309_3
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319004';
        P.cellID = '260319_1_Lv2';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 37; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
    ...
    elseif counter ==5
        %% 210309_5
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319006';
        P.cellID = '260319_1_Lv3.5';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==7
        %% 210309_1
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319016';
        P.cellID = '260319_2_Lv2';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==8
        %% 210309_1
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319017';
        P.cellID = '260319_2_Lv1';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==9
        %% 210309_1
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319018';
        P.cellID = '260319_1_Lv0.2';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==14
        %% 210309_1
        P.datapath = 'path\\20260319';
        P.fileName_opto = '26319037';
        P.cellID = '260319_6_MAX';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==15
        ...
        P.fileName_opto = '26320003';
        P.cellID = '260320_1_MAX';
        P.pksThreshold_opto = 0.35; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
    ...
    elseif counter ==17
        %% 210309_1
        P.datapath = 'path\\20260320';
        P.fileName_opto = '26320014';
        P.cellID = '260320_2_Lv1';
        P.pksThreshold_opto = 0.2; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 32; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=2; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
    ...
    elseif counter ==18
        %% 210309_2
        P.datapath = 'path\\20260320';
        P.fileName_opto = '26320018';
        P.cellID = '260320_3_MAX';
        P.pksThreshold_opto = 0.2; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==19
        %% 210309_3
        P.datapath = 'path\\20260320';
        P.fileName_opto = '26320019';
        P.cellID = '260320_4_MAX';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 37; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==21
        %% 210309_5
        P.datapath = 'path\\20260324';
        P.fileName_opto = '26324004';
        P.cellID = '260324_2_MAX';
        P.pksThreshold_opto = 0.225; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
    ...
    elseif counter ==24
        %% 210309_1
        P.datapath = 'path\\20260324';
        P.fileName_opto = '26324014';
        P.cellID = '260324_4_Lv3';
    ...
    elseif counter ==26
        %% 210309_2
        P.datapath = 'path\\20260324';
        P.fileName_opto = '26324018';
        P.cellID = '260324_5_MAX';
        P.pksThreshold_opto = 0.2; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==28
        %% 210309_4
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325004';
        P.cellID = '260325_1_Lv3';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==29
        %% 210309_5
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325005';
        P.cellID = '260325_1_Lv1.5';
        P.pksThreshold_opto = 6; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==30
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325006';
        P.cellID = '260325_1_Lv0.5';
        P.pksThreshold_opto = 6; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==32
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325013';
        P.cellID = '260325_3_Lv3';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 33; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
    ...
    elseif counter ==33
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325014';
        P.cellID = '260325_3_Lv2';
        P.pksThreshold_opto = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==34
        %% 210309_2
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325017';
        P.cellID = '260325_4_MAX';
        P.pksThreshold_opto = 3.7; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
    ...
    elseif counter ==35
        %% 210309_3
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325020';
        P.cellID = '260325_4_Lv3';
        P.pksThreshold_opto = 4; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 35; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
    ...
    elseif counter ==36
        %% 210309_4
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325021';
        P.cellID = '260325_4_Lv2';
    ...
    elseif counter ==39
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325031';
        P.cellID = '260325_5_Lv3';
        P.pksThreshold_opto = 4; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 30; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==40
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325032';
        P.cellID = '260325_5_Lv1';
        P.pksThreshold_opto = 5; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 33; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==43
        %% 210309_1
        P.datapath = 'path\\20260325';
        P.fileName_opto = '26325041';
        P.cellID = '260325_7_MAX';
        P.pksThreshold_opto = 0.6; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 31; % number of trials per file
        P.numStim_opto_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
    ...
    if P.spikeDetMode==1
        ...
        [D.pks_opto, D.locs_opto] = findpeaks(idx_pks,'MinPeakDistance',10);
