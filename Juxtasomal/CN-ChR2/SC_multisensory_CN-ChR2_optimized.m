...
% Optimized ViralInjection copy by Codex; 30-04-2026
...
for counter = 1:23 % Indicate which cell to analyse for example: (for counter = 1:3) or (for counter = 3)
    close all;
    ...
    if counter ==1
        ...
        P.fileName_LED = '25d17006';
        P.fileName_sound = '25d17008';
        P.fileName_puff = '25d17007'; % whisker
        P.cellID = '251217_4';
    ...
    elseif counter ==2
        %% 251217_5
        P.datapath = 'path\20251217';
        P.fileName_LED = '25d17011';
        P.fileName_sound = '25d17013';
        P.fileName_puff = '25d17012'; % whisker
        P.cellID = '251217_5';
        P.pksThreshold_LED = 0.2; % Spike detection threshold in mV
        P.pksThreshold_sound = 0.2; % Spike detection threshold in mV
        P.pksThreshold_puff = 0.2; % Spike detection threshold in mV
    ...
    elseif counter ==3
        ...
        P.fileName_LED = '25d18007';
        P.fileName_sound = '25d18010';
        P.fileName_puff = '25d18008'; % whisker
        P.cellID = '251218_4';
    ...
    elseif counter ==4
        %% 251218_5
        P.datapath = 'path\20251218';
        P.fileName_LED = '25d18013';
        P.fileName_sound = '25d18015';
        P.fileName_puff = '25d18014'; % whisker
        P.cellID = '251218_4';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
    ...
    elseif counter ==5
        %% 251218_6
        P.datapath = 'path\20251218';
        P.fileName_LED = '25d18018';
        P.fileName_sound = '25d18020';
        P.fileName_puff = '25d18019'; % whisker
        P.cellID = '251218_6';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 1; % Spike detection threshold in mV
    ...
    elseif counter ==6
        %% 251218_7
        P.datapath = 'path\20251218';
        P.fileName_LED = '25d18023';
        P.fileName_sound = '25d18021';
        P.fileName_puff = '25d18019'; % no data
        P.cellID = '251218_7';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 1; % Spike detection threshold in mV
        P.pksThreshold_puff = 2000 ; % no data
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==7
        %% 251218_8
        P.datapath = 'path\20251218';
        P.fileName_LED = '25d18025';
        P.fileName_sound = '25d18027';
        P.fileName_puff = '25d18026'; % whisker
        P.cellID = '251218_8';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 7.5; % Spike detection threshold in mV
        P.pksThreshold_puff = 5; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==8
        ...
        P.fileName_LED = '26127002';
        P.fileName_sound = '26127003';
        P.fileName_puff = '26127000'; % whisker
        P.cellID = '260127_1';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
    ...
    elseif counter ==9
        %% 260127_3
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127007';
        P.fileName_sound = '26127008';
        P.fileName_puff = '26127005'; % whisker
        P.cellID = '260127_3';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 1; % Spike detection threshold in mV
        P.pksThreshold_puff = 1; % Spike detection threshold in mV
    ...
    elseif counter ==10
        %% 260127_4
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127011';
        P.fileName_sound = '26127012';
        P.fileName_puff = '26127009'; % whisker
        P.cellID = '260127_4';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 3; % Spike detection threshold in mV
        P.pksThreshold_puff = 0.8; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==11
        %% 260127_5
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127015';
        P.fileName_sound = '26127016';
        P.fileName_puff = '26127013'; % whisker
        P.cellID = '260127_5';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 1; % Spike detection threshold in mV
        P.pksThreshold_puff = 1; % Spike detection threshold in mV
    ...
    elseif counter ==12
        %% 260127_6
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127017';
        P.fileName_sound = '26127020';
        P.fileName_puff = '26127013'; % no data
        P.cellID = '260127_6';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
    ...
    elseif counter ==13
        %% 260127_7
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127023';
        P.fileName_sound = '26127024';
        P.fileName_puff = '26127021'; % whisker
        P.cellID = '260127_7';
        P.pksThreshold_LED = 1; % Spike detection threshold in mV
        P.pksThreshold_sound = 1; % Spike detection threshold in mV
        P.pksThreshold_puff = 1; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=20;% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==14
        % 260127_8
        P.datapath = 'path\20260127';
        P.fileName_LED = '26127027';
        P.fileName_sound = '26127025';
        P.fileName_puff = '26127028';
        P.cellID = '260127_8';
    ...
    elseif counter ==15
        ...
        P.fileName_LED = '26128000';
        P.fileName_sound = '26128003';
        P.fileName_puff = '26128002';
        P.cellID = '260128_1';
        P.pksThreshold_LED = 4; % Spike detection threshold in mV
        P.pksThreshold_sound = 6; % Spike detection threshold in mV
        P.pksThreshold_puff = 5.5; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==16
        % 260128_3
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128007';
        P.fileName_sound = '26128003'; %no data
        P.fileName_puff = '26128009';
        P.cellID = '260128_3';
        P.pksThreshold_LED = 3; % Spike detection threshold in mV
        P.pksThreshold_sound = 1000; % Spike detection threshold in mV
        P.pksThreshold_puff = 0.7; % Spike detection threshold in mV
        P.side = 1; % 1=left hemisphere, 2=right hemisphere
        P.numReps = 50; % number of trials per file
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
    ...
    elseif counter ==17
        %% 260128_4
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128012';
        P.fileName_sound = '26128013';
        P.fileName_puff = '26128010'; % whisker
        P.cellID = '260128_4';
    ...
    elseif counter ==18
        % 260128_5
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128014';
        P.fileName_sound = '26128013';%no data
        P.fileName_puff = '26128016'; % whisker
        P.cellID = '260128_5';
        P.pksThreshold_LED = 4; % Spike detection threshold in mV
        P.pksThreshold_sound = 1000; % Spike detection threshold in mV
        P.pksThreshold_puff = 2; % Spike detection threshold in mV
        ...
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_puff_manual=3;% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
        P.peakamp_XwindowLim = 0.5; % Define the outer limit used for calculating the amplitude of reponse; - no need to change
    ...
    elseif counter ==19
        % 260128_6
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128017';
        P.fileName_sound = '26128013';%no data
        P.fileName_puff = '26128019'; % whisker
        P.cellID = '260128_6';
        P.pksThreshold_LED = 3; % Spike detection threshold in mV
        P.pksThreshold_sound = 1000; % Spike detection threshold in mV
        P.pksThreshold_puff = 1; % Spike detection threshold in mV
    ...
    elseif counter ==20
        % 260128_7
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128023';
        P.fileName_sound = '26128022';
        P.fileName_puff = '26128021'; % whisker
        P.cellID = '260128_7';
    ...
    elseif counter ==21
        % 260128_8
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128027';
        P.fileName_sound = '26128026';
        P.fileName_puff = '26128024'; % whisker
        P.cellID = '260128_8';
    ...
    elseif counter ==22
        % 260128_9
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128028';
        P.fileName_sound = '26128026';%no data
        P.fileName_puff = '26128030'; % whisker
        P.cellID = '260128_9';
        ...
        P.numStim_LED_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_sound_manual=[];% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.numStim_puff_manual=28;% Fill in # trials in case cell dies before the end of the recording. If all trials have spikes, leave empty.
        P.wavelength = 470; %!! Not important
        P.spikeDetMode=1; %1=upward going waveform, 2=downward going waveform
        P.yyaxis_lim = 50; % yyaxis limit for the PSTH plots - no need to change
        P.peakamp_XwindowLim = 0.5; % Define the outer limit used for calculating the amplitude of reponse; - no need to change
    ...
    elseif counter ==23
        %% 260128_10
        P.datapath = 'path\20260128';
        P.fileName_LED = '26128028';%no data
        P.fileName_sound = '26128026';%no data
        P.fileName_puff = '26128031'; % whisker
        P.cellID = '260128_10';
...
summaryOutputDir = 'path\ViralInjection_Mice';
if ~exist(summaryOutputDir,'dir')
    mkdir(summaryOutputDir);
end
cd(summaryOutputDir)
% Save data
savename = sprintf('OutputVars_ViralInjection_allcells.mat');
...
if exist('OutputVars','var') && ~isempty(OutputVars)
    ...
    excelDir = summaryOutputDir;
    if ~exist(excelDir,'dir')
        mkdir(excelDir);
    end
    excelPath = fullfile(excelDir,'OutputVars_ViralInjection_optimized.xlsx');
